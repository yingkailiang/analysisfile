...
// Generated on 2013-09-04 using generator-chrome-extension 0.2.4
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    // ui-bootstrap's template
                    expand: true,
                    cwd: '<%= yeoman.app %>/bower_components/angular-ui-bootstrap/template',
                    src: ['**/*.*'],
        ...
        compress: {
            dist: {
                options: {
                    archive: 'package/History Cards.zip'
                },
                files: [{
                    expand: true,
                    cwd: 'dist/',
