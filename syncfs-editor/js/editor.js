Editor = function(filesystem, container, filer) {
    ...
    tools.appendChild(createElement('span', {
        id: 'editor-path'
    }));
    ...
    if (window.CodeMirror) {
        this.cm_doc =
            CodeMirror(appendEditor.bind(this), {
                lineNumbers: true,
                theme: 'neat'
            });
    } else
...
Editor.prototype.showDialog = function(dialogOptions) {
    ...
    if (dialogOptions.dialogLabel) {
        dialog.appendChild(createElement(
            'div', {
                innerText: dialogOptions.dialogLabel
            }));
    }
    ...
    if (dialogOptions.inputLabel) {
        dialog.appendChild(createElement(
            'span', {
                innerText: dialogOptions.inputLabel
            }));
        dialog.appendChild(createElement(
            'input', {
                id: 'editor-dialog-input',
                type: 'text',
                size: 40
            }));
        getInputValue = function() {
            return $('#editor-dialog-input').value;
        };
    }
    var buttons = createElement('div', {
        class: 'editor-dialog-buttons'
    });
    buttons.appendChild(createElement(
        'input', {
            id: 'editor-dialog-submit',
            value: dialogOptions.submitLabel,
            type: 'button'
        }));
    buttons.appendChild(createElement(
        'input', {
            id: 'editor-dialog-cancel',
