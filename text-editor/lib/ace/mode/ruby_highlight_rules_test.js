...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "test: symbol tokenizer": function() {
            ...
            assertValidTokens(this.tokenizer, "string", [":@thing", ":$thing", ":_thing", ":thing", ":Thing", ":thing1", ":thing_a",
                ":THING", ":thing!", ":thing=", ":thing?", ":t?"
            ]);
            assertInvalidTokens(this.tokenizer, "string", [":", ":@", ":$", ":1", ":1thing", ":th?ing", ":thi=ng", ":1thing",
                ":th!ing", ":thing#"
            ]);
        },
        ...
        "test: hex tokenizer": function() {
            assertValidTokens(this.tokenizer, "constant.numeric", ["0x9a", "0XA1", "0x9_a"]);
            assertInvalidTokens(this.tokenizer, "constant.numeric", ["0x", "0x_9a", "0x9a_"]);
        },

        "test: float tokenizer": function() {
            assertValidTokens(this.tokenizer, "constant.numeric", ["1", "+1", "-1", "12_345", "0.000_1"]);
            assertInvalidTokens(this.tokenizer, "constant.numeric", ["_", "_1", "1_", "1_.0", "0._1"]);
        }
    };
