...
define(function(require, exports, module) {
    ...
    function unevalableConst(code) {
        ...
        var constName = definitions.opTypeNames.hasOwnProperty(token) ? definitions.opTypeNames[token] : token in definitions.keywords ? token.toUpperCase() : token;
        return {
            toSource: function() {
                return constName
            }
    ...
    Pp.Statement = function Statement() {
        var i, label, n, n2, p, c, ss, tt = this.t.get(true),
            tt2, x0, x2, x3;
            ...
            case FOR:
                ...
                if (n2 && this.match(IN)) {
                    ...
                    this.withContext(x3, function() {
                        ...
                        this.mustMatch(SEMICOLON);
                        tt2 = this.peek(true);
                        n.update = (this.parenFreeMode ? tt2 === LEFT_CURLY || definitions.isStatementStartCode[tt2] : tt2 === RIGHT_PAREN) ? null : this.Expression();
                    });
                }
                if (!this.parenFreeMode)
                    this.mustMatch(RIGHT_PAREN);
    ...
    Pp.ReturnOrYield = function ReturnOrYield() {
        ...
        if (tt2 !== END && tt2 !== NEWLINE &&
            tt2 !== SEMICOLON && tt2 !== RIGHT_CURLY && (tt !== YIELD ||
