...
kango.TabProxy=function(a){this._tab=a;this._listeners=[];this._invokeAsyncModule=new kango.InvokeAsyncModule(this);this._messageTargetModule=new kango.MessageTargetModule(this)};
...
kango.TabProxy.prototype.__exposedProps__={xhr:"r",console:"r",browser:"r",io:"r",event:"r",invokeAsync:"r",invokeAsyncCallback:"r",dispatchMessage:"r",addMessageListener:"r",removeMessageListener:"r",removeAllMessageListeners:"r"};kango.TabProxy.prototype.xhr.__exposedProps__={send:"r"};
