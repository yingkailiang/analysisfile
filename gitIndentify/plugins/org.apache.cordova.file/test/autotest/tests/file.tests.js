...
describe('File API', function() {
    ...
    describe('LocalFileSystem', function() {
        ...
        describe('window.requestFileSystem', function() {
            ...
            it("file.spec.4 should be able to retrieve a PERSISTENT file system", function() {
                ...
                }, "success callback never called", Tests.TEST_TIMEOUT);
            ...
            it("file.spec.6 should error if you request a file system that is too large", function() {
                ...
                }, "error callback never called", Tests.TEST_TIMEOUT);
        ...
        describe('window.resolveLocalFileSystemURI', function() {
            ...
            it("file.spec.9 should resolve a valid file name", function() {
                ...
                waitsFor(function() {
                    return resolveCallback.wasCalled;
    ...
    describe('DirectoryEntry', function() {
        ...
        it("file.spec.19 getFile: create file that already exists", function() {
            var fileName = "de.create.existing.file",
                ...
                getFile = jasmine.createSpy().andCallFake(function(file) {
                    ...
                    waitsFor(function() {
                        return win.wasCalled;
                    }, "win was never called", Tests.TEST_TIMEOUT);
            ...
            waitsFor(function() {
                return getFile.wasCalled;
            }, "getFile was never called", Tests.TEST_TIMEOUT);
        });
        it("file.spec.20 getFile: create file that already exists (exclusive)", function() {
            ...
            waitsFor(function() {
                return getFile.wasCalled;
            }, "getFile never called", Tests.TEST_TIMEOUT);
        });
        it("file.spec.21 getFile: get Entry for existing file", function() {
            var fileName = "de.get.file",
                ...
                getFile = jasmine.createSpy().andCallFake(function(file) {
                    ...
                    waitsFor(function() {
                        return win.wasCalled;
                    }, "getFile success callback", Tests.TEST_TIMEOUT);
            ...
            waitsFor(function() {
                return getFile.wasCalled;
            }, "file creation", Tests.TEST_TIMEOUT);
        });
        ...
        it("file.spec.24 DirectoryEntry.getDirectory: create new dir with space then resolveFileSystemURI", function() {
            ...
            waitsFor(function() {
                return getDir.wasCalled;
            }, "getDir never called", Tests.TEST_TIMEOUT);
        });
        ...
        it("file.spec.32 DirectoryEntry.getDirectory: get DirectoryEntry for existing file", function() {
            ...
            waitsFor(function() {
                return getDir.wasCalled;
            }, "getDir was called", Tests.TEST_TIMEOUT);
        });
        ...
        it("file.spec.34 DirectoryEntry.removeRecursively on directory", function() {
            var dirName = "de.removeRecursively",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    var deleteDirectory = jasmine.createSpy().andCallFake(function(directory) {
                        ...
                        waitsFor(function() {
                            return remove.wasCalled;
                        }, "remove never called", Tests.TEST_TIMEOUT);
                    });
                    // create a sub-directory within directory
                    runs(function() {
                        entry.getDirectory(subDirName, {
                            create: true
                        }, deleteDirectory, fail);
                    });

                    waitsFor(function() {
                        return deleteDirectory.wasCalled;
                    }, "deleteDirectory never called", Tests.TEST_TIMEOUT);
                }),
                remove = jasmine.createSpy().andCallFake(function() {
                    ...
                    waitsFor(function() {
                        return dirExists.wasCalled;
                    }, "dirExists never called", Tests.TEST_TIMEOUT);
            ...
            waitsFor(function() {
                return entryCallback.wasCalled;
                ...
                var dirName = "de.createReader.notfound",
                    ...
                    entryCallback = jasmine.createSpy().andCallFake(function(directory) {
                        ...
                        var readEntries = jasmine.createSpy().andCallFake(function() {
                            ...
                            waitsFor(function() {
                                return itReader.wasCalled;
                            }, "itReader never called", Tests.TEST_TIMEOUT);
                        });
                        // delete directory
                        runs(function() {
                        ...
                        waitsFor(function() {
                            return readEntries.wasCalled;
                        }, "readEntries never called", Tests.TEST_TIMEOUT);
                    }),
                    itReader = jasmine.createSpy().andCallFake(function(error) {
                        ...
                        runs(function() {
                            root.getDirectory(dirName, {
                                create: false
                            }, win, itDirectoryExists);
                        });

                        waitsFor(function() {
                            return itDirectoryExists.wasCalled;
                        }, "itDirectoryExists never called", Tests.TEST_TIMEOUT);
    ...
    describe('FileEntry', function() {
        it("file.spec.41 should be define FileEntry methods", function() {
            ...
            waitsFor(function() {
                return itFileEntry.wasCalled;
            }, "itFileEntry never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.42 createWriter should return a FileWriter object", function() {
            var fileName = "fe.createWriter",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(fileEntry) {
                    ...
                    waitsFor(function() {
                        return itWriter.wasCalled;
                    }, "itWriter", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.43 file should return a File object", function() {
            var fileName = "fe.file",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(fileEntry) {
                    ...
                    waitsFor(function() {
                        return itFile.wasCalled;
                    }, "itFile never called", Tests.TEST_TIMEOUT);
    ...
    describe('Entry', function() {
        it("file.spec.45 Entry object", function() {
            ...
            waitsFor(function() {
                return itEntry.wasCalled;
            }, "itEntry", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.46 Entry.getMetadata on file", function() {
            var fileName = "entry.metadata.file",
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    waitsFor(function() {
                        return itMetadata.wasCalled;
                    }, "itMetadata never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.48 Entry.getParent on file in root file system", function() {
            var fileName = "entry.parent.file",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    waitsFor(function() {
                        return itParent.wasCalled;
                    }, "itCalled never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.49 Entry.getParent on directory in root file system", function() {
            var dirName = "entry.parent.dir",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    waitsFor(function() {
                        return itParent.wasCalled;
                    }, "itParent never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.51 Entry.toURL on file", function() {
            ...
            waitsFor(function() {
                return itURI.wasCalled;
            }, "itURI never called", Tests.TEST_TIMEOUT);
            ...
            var fileName = "entry.rm.file",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    var checkRemove = jasmine.createSpy().andCallFake(function() {
                        ...
                        waitsFor(function() {
                            return itRemove.wasCalled;
                        }, "itRemove never called", Tests.TEST_TIMEOUT);
                    ...
                    waitsFor(function() {
                        return checkRemove.wasCalled;
                    }, "checkRemove never called", Tests.TEST_TIMEOUT);
                }),
        ...
        it("file.spec.59 copyTo: directory", function() {
            var file1 = "file1",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(directory) {
                    ...
                    waitsFor(function() {
                        return copyDir.wasCalled;
                    }, "copyDir never called", Tests.TEST_TIMEOUT);
                }),
                itCopy = jasmine.createSpy().andCallFake(function(directory) {
                    ...
                    waitsFor(function() {
                        return itDirExists.wasCalled;
                    }, "itDirExists never called", Tests.TEST_TIMEOUT);
                }),
        ...
        it("file.spec.60 copyTo: directory to backup at same root directory", function() {
            var file1 = "file1",
                ...
                itFileExists = jasmine.createSpy().andCallFake(function(fileEntry) {
                    ...
                    waitsFor(function() {
                        return cleanSrc.wasCalled && cleanDst.wasCalled;
                    }, "cleanSrc and cleanDst cleanup methods", Tests.TEST_TIMEOUT);
                });
        ...
        it("file.spec.61 copyTo: directory onto itself", function() {
            var file1 = "file1",
                ...
                itCopy = jasmine.createSpy().andCallFake(function(error) {
                    ...
                    waitsFor(function() {
                        return itDirectoryExists.wasCalled;
                    }, "itDirectoryExists", Tests.TEST_TIMEOUT);
                }),
        ...
        it("file.spec.65 moveTo: file to same parent", function() {
            var file1 = "entry.move.fsp.file1",
                ...
                itMove = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    waitsFor(function() {
                        return itMovedExists.wasCalled;
                    }, "itMovedExists never called", Tests.TEST_TIMEOUT);
                }),
                itMovedExists = jasmine.createSpy().andCallFake(function(fileEntry) {
                    ...
                    waitsFor(function() {
                        return itOrig.wasCalled;
                    }, "itOrig never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.66 moveTo: file to new parent", function() {
            var file1 = "entry.move.fnp.file1",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(entry) {
                    ...
                    waitsFor(function() {
                        return moveFile.wasCalled;
                    }, "moveFile never called", Tests.TEST_TIMEOUT);
                }),
                itMovedExists = jasmine.createSpy().andCallFake(function(fileEntry) {
                    expect(fileEntry).toBeDefined();
                    expect(fileEntry.fullPath).toCanonicallyMatch(dstPath);
        ...
        it("file.spec.67 moveTo: directory to same parent", function() {
            var file1 = "file1",
                ...
                entryCallback = jasmine.createSpy().andCallFake(function(directory) {
                    ...
                    waitsFor(function() {
                        return moveDir.wasCalled;
                    }, "moveDir never called", Tests.TEST_TIMEOUT);
                }),
        ...
        it("file.spec.76 moveTo: directory onto directory that is not empty", function() {
            ...
            waitsFor(function() {
                return itSrcDirectoryExists.wasCalled;
            }, "itSrcDirectoryExists never called", Tests.TEST_TIMEOUT);
        ...
        it("file.spec.78 moveTo: directory replace empty directory", function() {
            ...
            waitsFor(function() {
                return itRemoved.wasCalled;
            }, "itRemoved never called", Tests.TEST_TIMEOUT);
    ...
    describe('read method', function() {
        it("file.spec.82 should error out on non-existent file", function() {
            ...
            waitsFor(function() {
                return verifier.wasCalled;
            }, "verifier never called", Tests.TEST_TIMEOUT);
        });
    ...
    describe('FileWriter', function() {
        ...
        it("file.spec.96 should be able to write and append to file, createWriter", function() {
            ...
            waitsFor(function() {
                return anotherVerifier.wasCalled;
            }, "verifier never called", Tests.TEST_TIMEOUT);
