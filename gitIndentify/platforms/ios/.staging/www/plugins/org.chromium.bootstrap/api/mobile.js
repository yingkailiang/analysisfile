cordova.define("org.chromium.bootstrap.mobile.impl", function(require, exports, module) { // Copyright (c) 2012 The Chromium Authors. All rights reserved.
    ...
    exports.boot = function() {
        ...
        channel.onCordovaReady.subscribe(function() {
            ...
            var channelsToWaitFor = channel.deviceReadyChannelsArray.filter(function(c) {
                return c.type !== 'onDOMContentLoaded';
            });
