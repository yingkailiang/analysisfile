cordova.define("org.chromium.polyfill.xhr_features.xhr-blob", function(require, exports, module) { // Copyright (c) 2013 The Chromium Authors. All rights reserved.
    ...
    function proxyProperty(_this, propertyName, writable) {
        var descriptor = {
            configurable: true,
            get: function() {
                return _this._proxy[propertyName];
            }
        };
        if (writable) {
            ...
            get: function() {
                if (this._overrideResponseType === 'blob') {
                    ...
                    if (this._response === null) {
                        ...
                        this._response = new Blob([this._proxy.response], {
                            type: ct
                        });
                    }
