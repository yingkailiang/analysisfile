...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
	        function prevPage(){
		        var a = $("#logForm");
		        a.attr('action','LogManage!prevPage.action');
		        a.submit();
	    	}
	    	...
	    	function nextPage(){
	    		var a = $("#logForm");
		        a.attr('action','LogManage!nextPage.action');
		        a.submit();
        	}
        </script>
    		...
    		<div id="log">
    			<div class="filter">
                    ...
                    <select id="logType" style='width:140px; '  name="selectorValue"  class="common-select">
                        ...
                        <option value="SBoxGetObject,SBoxGetObjectVersion">下载</option>
                        <option value="SBoxCreateDir">新建文件夹</option>
                        <option value="SBoxMoveDir,SBoxMoveObject">移动</option>
                        <!--  <option value="SBoxCopyDir,SBoxCopyObject">复制</option>-->
                       <!--   <option value="SBoxPutAcl,SBoxQuitAcl">共享</option>-->
                        <option value="SBoxCreateOutsideChain">生成外链</option>
                        <option value="SBoxDeleteOutChain">取消外链</option>
                    </select>
	    		...
	    		<div class="list-table log">
	    		 		...
	    		 		<s:if test="logs.size > 0">
	    		 			...
	    		 			<li class="list-item">
                                <div class="col name">
                                    ...
                                    <div class="file-name" title="<s:property value="name"/>"><s:property value="name"/></div>
                                </div>
	    		 				<div class="col operator"><s:property value="operator"/></div>
                                ...
                                <div class="col time"><s:property value="time.substring(0,16)" /></div>
                                <div class="col operator"><s:property value="platform" /></div>
	    		 			</li>
	    		 		</s:iterator>
	    		 			</s:if> 
                            <s:else>
	    		 	...
	    		 	<div class="list-footer">
                        ...
                        <ul>
                                ...
                                <li _page="1"><span >...</span></li>
                                <li _page="1"><a href="javascript:setPage(<s:property value="page.allPage"/>);"><s:property value="page.allPage"/></a></li>
                                </s:if>
