...
public class AppLogManage extends CommonAction {
	...
	public String toPage() {
		try {
			...
			String getlog = sc.getAppLog(sboxAppLog.getStartTime(), sboxAppLog.getEndTime(), sboxAppLog.getStatus(),String.valueOf(sboxAppLog.getResourceType()),String.valueOf(sboxAppLog.getFlag()),sboxAppLog.getPageIndex(), sboxAppLog.getPagenum(), secretKey);
